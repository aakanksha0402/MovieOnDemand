  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created voucher as @voucher" do
        post :create, {:voucher => valid_attributes}, valid_session
        expect(assigns(:voucher)).to be_a(Voucher)
        expect(assigns(:voucher)).to be_persisted
      end

      it "redirects to the created voucher" do
        post :create, {:voucher => valid_attributes}, valid_session
        expect(response).to redirect_to(Voucher.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved voucher as @voucher" do
        post :create, {:voucher => invalid_attributes}, valid_session
        expect(assigns(:voucher)).to be_a_new(Voucher)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested voucher" do
        voucher = Voucher.create! valid_attributes
        put :update, {:id => voucher.to_param, :voucher => new_attributes}, valid_session
        voucher.reload
    ...
    context "with invalid params" do
      it "assigns the voucher as @voucher" do
        voucher = Voucher.create! valid_attributes
        put :update, {:id => voucher.to_param, :voucher => invalid_attributes}, valid_session
        expect(assigns(:voucher)).to eq(voucher)
      end
