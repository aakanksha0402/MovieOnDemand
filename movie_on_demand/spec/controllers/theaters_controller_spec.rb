...
RSpec.describe TheatersController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all theaters as @theaters" do
      ...
      expect(assigns(:theaters)).to eq([theater])
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new theater as @theater" do
      ...
      expect(assigns(:theater)).to be_a_new(Theater)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created theater as @theater" do
        post :create, {:theater => valid_attributes}, valid_session
        expect(assigns(:theater)).to be_a(Theater)
        expect(assigns(:theater)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved theater as @theater" do
        post :create, {:theater => invalid_attributes}, valid_session
        expect(assigns(:theater)).to be_a_new(Theater)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested theater" do
        theater = Theater.create! valid_attributes
        put :update, {:id => theater.to_param, :theater => new_attributes}, valid_session
        theater.reload
    ...
    context "with invalid params" do
      it "assigns the theater as @theater" do
        theater = Theater.create! valid_attributes
        put :update, {:id => theater.to_param, :theater => invalid_attributes}, valid_session
        expect(assigns(:theater)).to eq(theater)
      end
