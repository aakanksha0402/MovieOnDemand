...
RSpec.describe "staff_permissions/new", type: :view do
  before(:each) do
    assign(:staff_permission, StaffPermission.new(
      :manage_seat => false,
  ...
  it "renders new staff_permission form" do
    render

    assert_select "form[action=?][method=?]", staff_permissions_path, "post" do
