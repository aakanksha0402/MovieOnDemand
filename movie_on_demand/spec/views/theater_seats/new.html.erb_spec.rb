...
RSpec.describe "theater_seats/new", type: :view do
  before(:each) do
    assign(:theater_seat, TheaterSeat.new(
      :theater_screen => nil,
      :seat_type => "MyString",
      :row_count => 1,
      :column_count => 1,
  ...
  it "renders new theater_seat form" do
    render

    assert_select "form[action=?][method=?]", theater_seats_path, "post" do
